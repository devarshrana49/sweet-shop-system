      ...
      <form onSubmit={handleSubmit}>
        <div>
          <input
            ...
            onChange={handleChange}
            required
            className="form-input" // Style for the input field
          />
        </div>
        <div>
          <input
        ...
        <button type="submit" className="submit-button"> {/* Style for the main button */}
          {isRegister ? 'Register' : 'Login'}
        </button>
      </form>
      <p>
        ...
        <button 
          onClick={() => setIsRegister(!isRegister)}
          className="link-button" // A class for the text-like button
        >
          {isRegister ? 'Login' : 'Register'}
        </button>
      </p>
